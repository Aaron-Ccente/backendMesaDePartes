...
export async function seed(knex) {
  ...
  await knex('tipo_de_examen').insert([
    { id_tipo_de_examen: 1, nombre: 'Toxicologico' },
    { id_tipo_de_examen: 2, nombre: 'Dosaje etilico' },
  ...
  await knex('tipo_de_examen_departamento').insert([
    { id_tipo_departamento: ID_DEPTO_TOXICOLOGIA, id_tipo_de_examen: 1 }, // Toxicologico
    { id_tipo_departamento: ID_DEPTO_TOXICOLOGIA, id_tipo_de_examen: 2 }, // Dosaje etilico
