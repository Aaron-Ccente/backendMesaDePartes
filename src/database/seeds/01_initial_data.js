...
export async function seed(knex) {
  ...
  await knex('tipo_de_examen').insert([
    ...
    { id_tipo_de_examen: 1, nombre: 'Balistico en armas, Municiones - elementos balísticos o análogos' },
    { id_tipo_de_examen: 2, nombre: 'Balístico en ropas' },
    { id_tipo_de_examen: 3, nombre: 'Inspección Balística' },
    { id_tipo_de_examen: 4, nombre: 'Identidad Balística, Marcas de herramientas, EMC estudio microscópico comparativo' },
    { id_tipo_de_examen: 5, nombre: 'Informes Técnicos, Especializados - Recontrucciones judiciales/Fiscales' },
    { id_tipo_de_examen: 6, nombre: 'Materiales, Insumos, Productos, Artefactos explosivos' },
    { id_tipo_de_examen: 7, nombre: 'Inspección Explosivos' },
    { id_tipo_de_examen: 8, nombre: 'TRICOLÓGICO (cabellos - vellos)' },
    { id_tipo_de_examen: 9, nombre: 'HEMATOLÓGICO' },
    { id_tipo_de_examen: 10, nombre: 'ESPERMATOLÓGICO' },
    { id_tipo_de_examen: 11, nombre: 'SARRO UNGUEAL' },
    { id_tipo_de_examen: 12, nombre: 'HOMOLOGACIÓN DE ADN' },
    { id_tipo_de_examen: 13, nombre: 'FISICO - en armas blancas' },
    { id_tipo_de_examen: 14, nombre: 'FISICO - en prendas de vestir' },
    { id_tipo_de_examen: 15, nombre: 'FISICO - en objetos rígidos (contundentes)' },
    { id_tipo_de_examen: 16, nombre: 'FISICO - en elementos constrictores' },
    { id_tipo_de_examen: 17, nombre: 'FISICO - en sustancias terrosas' },
    { id_tipo_de_examen: 18, nombre: 'FISICO - en artefactos incendiarios de fabricación casera' },
    { id_tipo_de_examen: 19, nombre: 'FISICO - en placas vehiculares' },
    { id_tipo_de_examen: 20, nombre: 'FISICO - en de homologación de pinturas en evidencias trazas' },
    { id_tipo_de_examen: 21, nombre: 'Examen de sustancias químicas impregnadas en prendas de vestir' },
    { id_tipo_de_examen: 22, nombre: 'Examen de hidrocarburos derivados de petróleo y/o aceites impregnados en prendas de vestir' },
    { id_tipo_de_examen: 23, nombre: 'Revenido químico de números de serie en soportes metálicos' },
    { id_tipo_de_examen: 24, nombre: 'Examen de homologación fisica en productos industriales' },
    { id_tipo_de_examen: 25, nombre: 'Examen de absorción atómica para restos de disparo por arma de fuego' },
    { id_tipo_de_examen: 26, nombre: 'Examen para detección de hidrocarburos derivados del petróleo' },
    { id_tipo_de_examen: 27, nombre: 'Exámenes instrumentales de espectrometría de infrarrojo FTIR para la detección de sustancias desconocidas' },
    { id_tipo_de_examen: 28, nombre: 'ANÁLISIS INFORMÁTICO FORENSE' },
    { id_tipo_de_examen: 29, nombre: 'OPERATIVIDAD DE EQUIPO TERMINAL MÓVIL, TARJETA SIM' },
    { id_tipo_de_examen: 30, nombre: 'ANÁLISIS DE ARCHIVOS DE VIDEOGRAMAS E IMAGEN' },
    { id_tipo_de_examen: 31, nombre: 'HOMOLOGACIÓN DE IMÁGENES DE VIDEO' },
    { id_tipo_de_examen: 32, nombre: 'OPERATIVIDAD DE DISPOSITIVOS ELECTRÓNICOS' },
    ...
    { id_tipo_de_examen: 38, nombre: 'Examen de determinación por adicción o supresión en documentos' },
    { id_tipo_de_examen: 39, nombre: 'Examen de superposición o prelación de trazos, para determinar abuso de firmas en blanco' },
    { id_tipo_de_examen: 40, nombre: 'Examen de entrecruzamiento de trazos, de tintas y dobleces' },
    { id_tipo_de_examen: 41, nombre: 'Examen de procedencia de fotocopias' },
    { id_tipo_de_examen: 42, nombre: 'Examen de determinación de fotomontaje o fotocomposiciones' },
    { id_tipo_de_examen: 43, nombre: 'Examen de autenticidad o falsedad de documentos de identidad' },
    { id_tipo_de_examen: 44, nombre: 'Examen de sistemas de impresión' },
    { id_tipo_de_examen: 45, nombre: 'Examen de papel carbón y papel auto-copiativo' },
    { id_tipo_de_examen: 46, nombre: 'Examen en sobres, embalajes y afines, a fin de establecer posible violación de correspondencia' },
    { id_tipo_de_examen: 47, nombre: 'Anacronismo en el receptor, normativo y tecnológico' },
    { id_tipo_de_examen: 48, nombre: 'Examen de autenticidad o falsedad de firmas' },
    { id_tipo_de_examen: 49, nombre: 'Examen de procedencia - auditoría de manuscritos' },
    { id_tipo_de_examen: 50, nombre: 'Examen de análisis de moneda nacional y/o extranjera' },
    { id_tipo_de_examen: 51, nombre: 'Informe Pericial en Lavado de Activos' },
    { id_tipo_de_examen: 52, nombre: 'Tasación de bienes muebles' },
    { id_tipo_de_examen: 53, nombre: 'Tasaciones de predios urbanos' },
    { id_tipo_de_examen: 54, nombre: 'Tasaciones de predios rústicos, predios erizados y otros bienes agropecuarios' },
    { id_tipo_de_examen: 55, nombre: 'Tasación de propiedad empresarial' },
    { id_tipo_de_examen: 56, nombre: 'Tasaciones en bienes inmuebles en los procesos de adquisición o expropiación' },
    { id_tipo_de_examen: 57, nombre: 'Tasaciones de aeronaves, embarcaciones y yacimientos mineros' },
    { id_tipo_de_examen: 58, nombre: 'Examen Psicológico en Personas' },
    { id_tipo_de_examen: 59, nombre: 'Análisis Psicografológico de Manuscritos' },
    { id_tipo_de_examen: 60, nombre: 'Pronunciamiento Psicológico en Material Diverso' },
    { id_tipo_de_examen: 61, nombre: 'Perfiliación Criminal en la Escena del Crimen' },
    { id_tipo_de_examen: 62, nombre: 'Entrevista Psicológica Retrospectiva (necropsia)' },
    { id_tipo_de_examen: 63, nombre: 'Procesamiento de fragmentos de huellas papilares latentes, para identidad dactilar y/o personal' },
    { id_tipo_de_examen: 64, nombre: 'Identidad dactilar y/o personal en documentos cuestionados' },
    { id_tipo_de_examen: 65, nombre: 'Identidad plena en persona' },
    { id_tipo_de_examen: 66, nombre: 'Enrolamiento biométrico en vivo' },
    { id_tipo_de_examen: 67, nombre: 'Identificación de cadáveres NN' },
    { id_tipo_de_examen: 68, nombre: 'Procesamiento de latentes faciales para identidad facial y/o personal' },
    { id_tipo_de_examen: 69, nombre: 'Homologación facial o identificación facial' },
    { id_tipo_de_examen: 70, nombre: 'Confección de IDENTIFAC' },
    { id_tipo_de_examen: 71, nombre: 'SARRO UNGUEAL' }
  ]);
  ...
  await knex('tipo_de_examen_departamento').insert([
    ...
    { id_tipo_departamento: 6, id_tipo_de_examen: 71 } // Sarro Ungueal
  ]);
